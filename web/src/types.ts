...
export interface SouvenirShop { id: string; nameKo: string; nameEn: string | null; address: string; lat: number; lng: number; distanceM: number; items: string[]; openTime: string; closeTime: string; cardPayment: boolean; foreignAssistance: boolean; localScore: number; sponsored: false }
