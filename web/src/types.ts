...
export interface StoryRecord { id: string; authorId: string; authorLabel: string; placeId: string; placeName: string; tripId: string | null; dayIndex: number | null; visitDate: string | null; plannedArrival: string | null; content: string; images: string[]; visibility: string; visitVerified: boolean; areaLabel: string; publishAt: string; moderationStatus: string; createdAt: string; isFollowing: boolean; mine: boolean }
export interface SocialMapPin { id: string; layer: "me" | "party" | "travelers"; authorId: string; authorLabel: string; placeId: string; placeName: string; category: string; lat: number; lng: number; gridCell: string | null; content: string; images: string[]; facts: Record<string, boolean | string>; language: "KO" | "EN"; visitVerified: true; areaLabel: string; publishedAt: string; commentCount: number; imageUrl: string | null }
export interface FogMapState { scope: "me" | "party"; cells: { cell: string; lat: number; lng: number }[]; progress: { clearedCellCount: number; totalCellCount: number; percent: number; districtCount: number }; dex: { unlockedCount: number; totalCount: number; entries: { tag: string; placeId: string; placeName: string; unlockedAt: string }[] } }
export interface StoryComment { id: string; authorId: string; authorLabel: string; body: string; language: "KO" | "EN"; createdAt: string }
