...
export const ROUTE_TREE: RouteNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "plan.conditions", path: "conditions", expoPath: "app/plan/conditions.tsx", titleKo: "3단계 · 이용 조건", titleEn: "Conditions", purpose: "반려동물·외국인 편의·알레르기·식단·숙소를 입력한다.", platform: "BOTH", access: "PUBLIC", apis: ["GET /api/places?category=LODGING"], owners: ["FE"], milestone: "M1_WEB", status: "DONE" },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "trip.map", path: "map", expoPath: "app/trips/[tripId]/map.tsx", titleKo: "지도 전체보기", titleEn: "Map", purpose: "지도를 전체 화면으로 확대해 전체 동선·반려동물 안전지점·기념품샵 레이어를 본다.", platform: "BOTH", access: "TRIP_VIEWER", apis: ["GET /api/routes/directions", "GET /api/pet-safety", "GET /api/shops/souvenir"], owners: ["FE"], milestone: "M1_WEB", status: "PARTIAL" },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "place.petPolicy", path: "pet-policy", expoPath: "app/places/[placeId]/pet-policy.tsx", titleKo: "반려동물 정책", titleEn: "Pet policy", purpose: "동반 조건·크기 제한·출처와 확인일자를 보여주고 현장과 다르면 제보받는다.", platform: "BOTH", access: "PUBLIC", apis: ["GET /api/places/:id/pet-policy", "POST /api/places/:id/pet-policy/reports"], owners: ["FE", "BE"], milestone: "M2_APP", status: "TODO" },
    ],
  },
  {
    id: "stories",
