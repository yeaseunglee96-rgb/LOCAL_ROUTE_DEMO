...
1. `npm ci`
2. `cd server && npx prisma migrate deploy && npm run seed && npm run seed:pet-safety && npm run seed:translations && npm run seed:commerce && npm run seed:v2 && npm run seed:discover-tags`
